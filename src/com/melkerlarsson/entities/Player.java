...
import com.melkerlarsson.renderEngine.DisplayManager;
...
public class Player extends Entity {
    ...
    private static final float JUMP_POWER = MASS * 2f;
    ...
    public void move(Terrain terrain) {
        ...
        upwardsSpeed -= GRAVITY * MASS * DisplayManager.getFrameTimeSeconds();
